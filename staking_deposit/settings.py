...
# Davinchi setting
DavinchiSetting = BaseChainSetting(
    NETWORK_NAME=DAVINCHI, GENESIS_FORK_VERSION=bytes.fromhex('10000293'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('7fd081efd2e10ca333c734f3a5e79459ff0be301868113703ed3c284adb85aef'))
